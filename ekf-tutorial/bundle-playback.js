...
, function(t, e, n) {
    ...
    function s(t) {
        var e = function(t) {
            ...
            [t.slice(-14, -10), t.slice(-10, -8), t.slice(-8, -6), t.slice(-6, -4), t.slice(-4, -2), t.slice(-2)]
        }(t);
...
, function(t, e, n) {
    ...
    function a(t, e, n, r) {
        return r = r || {},
        Object(o.a)("POST", "/__wb/web-archive/", (function(t) {
    ...
    var c = function() {
        ...
        (n = [{
            ...
            key: "failure",
            value: function(t) {
                401 == t.status ? this.userNotLoggedIn(t) : (this.hide(["wm-save-snapshot-in-progress", "wm-save-snapshot-success"]),
            ...
            value: function() {
                ...
                t ? (this.show("wm-save-snapshot-open"),
...
, , , , , , , function(t, e, n) {
    ...
    function y(t, e, n) {
        ...
        var a = [];
        function c(t, n) {
            var o, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "src", i = window.location.origin, s = T(window, t), c = m(s);
            try {
                for (c.s(); !(o = c.n()).done; ) {
                    var l = o.value;
                    if (!n || n(l)) {
                        ...
                        var n = document.createElement("span")
                          , a = function(t, e) {
                            ...
                            var f = Math.floor(n / 1e3)
                              , h = [];
                            s > 1 ? (h.push(s + " years"),
                            r = !0) : 1 == s && (h.push(s + " year"),
                            r = !0);
                            a > 1 ? (h.push(a + " months"),
                            r = !0) : 1 == a && (h.push(a + " month"),
                            r = !0);
    ...
    function g(t, e) {
        for (var n = e.split("/").splice(6).join("/"), o = t.document.querySelectorAll("img[src$='" + n + "'], iframe[src$='" + n + "'], frame[src$='" + n + "']"), r = Array.prototype.slice.call(o), i = 0; i < t.frames.length; i++)
            try {
    ...
    function T(t, e) {
        for (var n = t.document.getElementsByTagName(e), o = Array.prototype.slice.call(n), r = 0; r < t.frames.length; r++)
            try {
    ...
    var j = function() {
        ...
        return x(t, [{
            ...
            value: function(t) {
                ...
                if (this.cache[e] = t,
                t.length && e.length >= this.minChars) {
            ...
            key: "keydownHandler",
            value: function(t) {
                var e, n = this, o = window.event ? t.keyCode : t.which;
                if ((40 == o || 38 == o) && this.sc.innerHTML)
                    return (r = this.sc.querySelector(".wb-autocomplete-suggestion.selected")) ? (e = 40 == o ? r.nextSibling : r.previousSibling) ? (r.className = r.className.replace("selected", ""),
                    e.className += " selected",
                    this.input.value = e.getAttribute("data-val")) : (r.className = r.className.replace("selected", ""),
                    this.input.value = this.last_val,
                    e = 0) : ((e = 40 == o ? this.sc.querySelector(".wb-autocomplete-suggestion") : this.sc.childNodes[this.sc.childNodes.length - 1]).className += " selected",
                ...
                if (27 == o)
                    ...
                    var r;
                    (r = this.sc.querySelector(".wb-autocomplete-suggestion.selected")) && "none" != this.sc.style.display && (this.onSelect(t, r.getAttribute("data-val"), r),
                    setTimeout((function() {
    ...
    var U, P, I = window.JSON, D = window.open, q = window.Date, B = window.fetch, F = document, W = document, X = function(t) {
        return W.getElementById(t)
    };
    var Y, $ = "/static/";
    function J(t) {
        U.classList.contains("wm-closed") ? (t && P.classList.add("notice-only"),
        U.classList.replace("wm-closed", "wm-open"),
        P.style.display = "block",
        y(Y, $, X)) : (U.classList.replace("wm-open", "wm-closed"),
    ...
    window.__wm = {
        init: function(t) {
            ...
            document.createElementNS = function(t, e) {
                return 0 == t.indexOf(o) && (t = t.substring(o.length).replace(/\/?[0-9]+\//, "")),
        ...
        bt: function(t, e, n, o, r, i, s, a, l, m, v) {
            ...
            $ = l || "/static/",
            Y = s;
            var g, b, w, S = "/" + (r || "web") + "/", T = f.c(Y), M = T.getUTCFullYear(), _ = T.getUTCMonth() + 1, C = T.getUTCDate(), x = -1, k = -1, O = X("wm-ipp-base");
            if (O.attachShadow) {
                var E = O.attachShadow({
                    mode: "closed"
                });
                for (W = E; O.children.length > 0; )
                    E.appendChild(O.children[0]);
                if (m)
                ...
                if (window.top != window.self)
                    ...
                    window.addEventListener("message", (function(t) {
                        if (t.source === Q) {
                            ...
                            if (console.log("got message %o", e),
                            "set height" == e.event) {
                                var n = e.value
                                  , o = e.bannerHeight;
                    ...
                    console.debug("installed message listener to #donato-base: %o", tt)
                }
            X("wm-tb-close").addEventListener("click", (function(t) {
                X("wm-ipp-inside").style.display = "none",
                t.preventDefault(),
                N()
            }
            ));
            ...
            et.onmousemove = function(e) {
                var r, s, c = et, l = function(t) {
                    var e = 0;
                    return t.pageX || t.pageY ? e = t.pageX : (t.clientX || t.clientY) && (e = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft),
                    e
                }(e), u = (r = c,
                s = F.documentElement,
                (void 0 !== r.getBoundingClientRect ? r.getBoundingClientRect() : {
                    top: 0,
                    left: 0
                }).left + (window.pageXOffset || s.scrollLeft) - (s.clientLeft || 0)), h = Math.min(Math.max(0, l - u), t), d = h % n, m = Math.floor(h / n), v = Math.min(11, Math.floor(d / o)), y = 12 * m + v, g = d % 2 == 1 ? 15 : 1, T = p(m + a) + p(v + 1, 2) + p(g, 2) + "000000";
                X("displayYearEl").innerHTML = m + a,
                X("displayMonthEl").innerHTML = f.b(v);
                var M = S + T + "/" + i;
                if (X("wm-graph-anchor").href = M,
                x != m) {
                    var _ = m * n;
                    b.style.left = _ + "px",
                    x = m
            ...
            if (rt.getContext && rt.getContext("2d")) {
                                ...
                                for (var y = (l - 1) / 12, g = 0; g < f.length; g++) {
                                    ...
                                    for (var b = f[g][1], w = _(v) + 1, S = 0; S < 12; S++) {
                                        ...
                                        if (T > 0) {
                                            ...
                                            a.fillRect(Math.round(w), Math.ceil(n - M), Math.ceil(y), Math.round(M))
                                        }
                                        w += y
                                    }
                                }
                ...
                var st = new Image;
                st.src = "/__wb/sparkline?url=" + encodeURIComponent(i) + "&width=" + t + "&height=" + e + "&selected_year=" + M + "&selected_month=" + _ + (r && "&collection=" + r || ""),
                st.alt = "sparkline",
                st.width = t,
                st.height = e,
            ...
            X("wm-share-facebook").onclick = function(t) {
                ...
                return D("https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(e), "", "height=400,width=600"),
                t.preventDefault(),
                !1
            }
            ,
            X("wm-share-twitter").onclick = function(t) {
                var e = this.dataset.url;
                return D("https://twitter.com/intent/tweet?text=" + encodeURIComponent(e) + "&via=internetarchive", "", "height=446,width=600"),
                t.preventDefault(),
                !1
            }
            ,
                ...
                source: function(t, e) {
                    Object(u.a)("GET", "/__wb/search/host?q=" + encodeURIComponent(t), (function(n) {
                        if (void 0 !== (n = I.parse(n.response)).hosts && n.hosts.length > 0) {
                            ...
                            void 0 !== n.isUrl && !0 === n.isUrl && void 0 === n.excluded ? e([t]) : Object(u.a)("GET", "/__wb/search/anchor?q=" + encodeURIComponent(t), (function(t) {
            ...
            X("wmtb").onsubmit = function(t) {
                ...
                if (0 !== e.indexOf("http://") && 0 !== e.indexOf("https://") && !e.match(/[\w\.]{2,256}\.[a-z]{2,4}/gi))
                    return document.location.href = "/web/*/" + X("wmtbURL").value,
                    t.preventDefault(),
                    !1
            }
            ,
            function(t, e) {
                K(t, e, (function(t, e) {
                    t ? (X("wm-screenshot").title = "screen shot (delta: " + e + "s)",
                    z("wm-screenshot", !0)) : z("wm-screenshot", !1)
                }
                ))
            }(i, Y),
            v && function(t, e) {
